...
ServerConfig::ServerConfig(const ServerConfig& other) : host_(other.host_), port_(other.port_), backlog_(other.backlog_), buffer_size_(other.buffer_size_), document_root_(other.document_root_), listens_(other.listens_) {}
ServerConfig& ServerConfig::operator=(const ServerConfig& other) {
    if (this != &other) { host_ = other.host_; port_ = other.port_; backlog_ = other.backlog_; buffer_size_ = other.buffer_size_; document_root_ = other.document_root_; listens_ = other.listens_;}
    return *this;
}
